...
<head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
       	<meta name="description" content="responsive creative ">
		<meta name="keywords" content="portfolio,webdeveloper, Web, design, Bengaluru, candidate">

		<!-- title -->
		<title>Maheshwari B</title>
...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,500,600,700,800,900" rel="stylesheet">
    ...
    <body>
		  ...
		  <div class="container">
		    ...
		    <div class="navbar-header">
		      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#nav-icon-collapse" aria-expanded="false">
		       ...
		       <!-- logo -->
		      <a class="logo" href="#">Maheshwari</a>
		    ...
		    <div class="collapse navbar-collapse" id="nav-icon-collapse">
		      ...
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <li><a href="#" data-scroll-nav="1">Know Me</a></li>
		...
		<!-- ====== Header ======  -->
		<section id="home" class="header" data-scroll-index="0" style="background-image: url(assets/img/bg.jpg);" data-stellar-background-ratio="0.8">
						...
						<div class="caption">
							...
							<h1 class="cd-headline clip">
					            ...
					            <span class="cd-words-wrapper">
					              <b class="is-visible">Maheshwari B</b>
					              <b>Developer</b>
					              <b>Designer</b>
					            </span>
			          		</h1>
				...
				<div class="row">
					...
					<div class="col-md-7">
						<div class="content mb-30">
							<h3>About Me.</h3>
							<span class="sub-title">UI / UX  & Web Developer</span>
							<p>I am <b>Maheshwari B</b> I am a web developer and designer living in Bengaluru, India. I spend my days in coding to make my website look great in all aspects I love to work in web development from back end programming (PHP) to front end engineering (HTML, CSS, and jQuery/Javascript) and visual design. <br> <br> I am extremely passionate about web development and design in all it’s forms. Aside from web development, I enjoy learning new languages, Travelling, watching movies, reading books and doing mimicry. </p>
			...
			<div class="container">
				<div class="row">
					...
					<div class="filtering text-center mb-50">
						...
						<span data-filter='.brand'>Static</span>
						<span data-filter='.web'>Dynamic</span>
						<span data-filter='.graphic'>Other</span>
					</div>
		...
		<footer>
			<div class="container text-center">
				<div class="row">
					<p>Copy Right 2018 &copy; By Maheshwari B All Rights Reserved</p>
				</div>
			</div>
		</footer>
		<!--====== End Footer ======-->
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.css">
    </script>
...
<!-- Mirrored from daniels.bitballoon.com/creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Apr 2018 08:34:05 GMT -->
</html>
